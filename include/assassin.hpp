...
class Assassin : public Character {
    ...
    public:
        // ctor dtor
        Assassin(string name,  int strength = 16, int agility = 20, int intelligence = 28, int level = BASE_LEVEL, int exp = BASE_EXP, int gold = BASE_GOLD, int masteryCost = BASE_MASTERY_COST);
        ~Assassin();
