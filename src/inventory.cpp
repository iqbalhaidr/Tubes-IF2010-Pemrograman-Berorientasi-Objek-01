...
void Inventory :: generalEquip(std::string slot, Character& orang, Item* item, Unit& target){
    reduceItem(item,1);
...
void Inventory :: generalUnequip(std::string slot, Character& orang, Unit& target){
